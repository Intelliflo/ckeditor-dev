CKEDITOR.plugins.add('imagebrowser', {
	"init": function (editor) {
		...
		editor.config.filebrowserImageBrowseUrl = "/nio/campaignmanagementtemplate/listtemplateimages";
		editor.config.filebrowserImageUploadUrl = "/nio/campaignmanagementtemplate/uploadtemplateimage";
		editor.config.filebrowserImageWindowWidth = 500;
		editor.config.filebrowserImageWindowHeight = 300;
	}
});
