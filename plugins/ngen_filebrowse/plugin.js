...
( function()
{
   ...
   function browseServer( evt )
   {
      ...
      var dialog = new CKEDITOR.dialog( editor, 'ngen_filebrowse', url );
      
      
      dialog.definition.minWidth = width;
      dialog.definition.minHeight = height;
   ...
   CKEDITOR.plugins.add( 'ngen_filebrowse',
   {
      ...
      init : function( editor, pluginPath )
      {
         ...
         CKEDITOR.dialog.add('ngen_filebrowse', function ()
               {
                  return {
